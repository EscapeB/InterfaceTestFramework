...
public class GroupMyHasgroupTest {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public GroupMyHasgroupTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupMyHasgroupTest.xls";
		this.tcEntry.TestSuitName=testsuitname;
		//this.tcEntry.tcLogFilePathName=logfile.getAbsolutePath();
		this.tcEntry.logFile=logfile;
		this.tcm=tcmanager;
	}
	public void MyHasgroup() throws IOException{
		this.tcEntry.tcName="MyHasgroup";
