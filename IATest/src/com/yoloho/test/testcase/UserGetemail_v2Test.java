...
public class UserGetemail_v2Test {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public UserGetemail_v2Test(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_UserGetemail_v2Test.xls";
