...
public class UserGetcitiiesTest {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public UserGetcitiiesTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_UserGetcitiiesTest.xls";
