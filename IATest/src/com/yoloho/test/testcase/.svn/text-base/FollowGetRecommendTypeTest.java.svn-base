...
public class FollowGetRecommendTypeTest {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public FollowGetRecommendTypeTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_FollowGetRecommendTypeTest.xls";
