...
public class GroupMyMygroup_v2Test {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public GroupMyMygroup_v2Test(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupMyMygroup_v2Test.xls";
		this.tcEntry.TestSuitName=testsuitname;
		//this.tcEntry.tcLogFilePathName=logfile.getAbsolutePath();
		this.tcEntry.logFile=logfile;
		this.tcm=tcmanager;
	}
	public void MyMygroup_v2() throws IOException{
		this.tcEntry.tcName="MyMygroup_v2";
