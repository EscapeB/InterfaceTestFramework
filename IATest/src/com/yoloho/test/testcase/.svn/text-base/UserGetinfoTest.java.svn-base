...
public class UserGetinfoTest 
{
	...
	public UserGetinfoTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_UserGetinfoTest.xls";
		this.tcEntry.TestSuitName=testsuitname;
		this.tcEntry.logFile=logfile;
		this.tcm=tcmanager;
	}
	
	public void Getinfo_g1() throws IOException
	{
		
		this.tcEntry.tcName="Getinfo_g1";
