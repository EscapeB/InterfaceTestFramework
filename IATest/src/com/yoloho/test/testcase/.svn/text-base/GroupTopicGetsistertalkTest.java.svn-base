...
public class GroupTopicGetsistertalkTest {
	public TestcaseEntry tcEntry;
	public TestcaseManager tcm;
	public GroupTopicGetsistertalkTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupTopicGetsistertalkTest.xls";
		this.tcEntry.TestSuitName=testsuitname;
		//this.tcEntry.tcLogFilePathName=logfile.getAbsolutePath();
		this.tcEntry.logFile=logfile;
		this.tcm=tcmanager;
	}
	public void TopicGetsistertalk() throws IOException{
		this.tcEntry.tcName="TopicGetsistertalk";
