...
public class FollowGetFansList {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public FollowGetFansList(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_FollowGetFansList.xls";
