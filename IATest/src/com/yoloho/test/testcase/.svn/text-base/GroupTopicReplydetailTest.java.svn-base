...
public class GroupTopicReplydetailTest {
	public TestcaseEntry tcEntry;
	public TestcaseManager tcm;
	public GroupTopicReplydetailTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupTopicReplydetailTest.xls";
		this.tcEntry.TestSuitName=testsuitname;
		//this.tcEntry.tcLogFilePathName=logfile.getAbsolutePath();
		this.tcEntry.logFile=logfile;
		this.tcm=tcmanager;
	}
	public void TopicReplydetail() throws IOException{
		this.tcEntry.tcName="TopicReplydetail";
	...
	public void TopicReplydetail_wrongId() throws Exception{
		this.tcEntry.tcName="TopicReplydetail_wrongId";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		Testcase.getResponse(this.tcEntry);
		result=Testcase.VerfyResult(this.tcEntry);
	...
	public void TopicReplydetail_nullId() throws Exception{
		this.tcEntry.tcName="TopicReplydetail_nullId";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		Testcase.getResponse(this.tcEntry);
		result=Testcase.VerfyResult(this.tcEntry);
