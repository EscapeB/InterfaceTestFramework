...
public class FollowHasNewFansTest 
{
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public FollowHasNewFansTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_FollowHasNewFansTest.xls";
