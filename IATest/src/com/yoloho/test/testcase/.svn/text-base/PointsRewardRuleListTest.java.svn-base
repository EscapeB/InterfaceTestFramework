...
public class PointsRewardRuleListTest 
{
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public PointsRewardRuleListTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_PointsRewardRuleListTest.xls";
