...
public class GroupTopicGetmyassistantlistTest {
	public TestcaseEntry tcEntry;
	public TestcaseManager tcm;
	
	public GroupTopicGetmyassistantlistTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupTopicGetmyassistantlistTest.xls";
		this.tcEntry.TestSuitName=testsuitname;
		//this.tcEntry.tcLogFilePathName=logfile.getAbsolutePath();
		this.tcEntry.logFile=logfile;
		this.tcm=tcmanager;
	}
	public void TopicGetmyassistantlist() throws IOException{
		this.tcEntry.tcName="TopicGetmyassistantlist";
