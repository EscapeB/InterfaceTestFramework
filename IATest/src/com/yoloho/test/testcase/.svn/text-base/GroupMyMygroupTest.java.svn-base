...
public class GroupMyMygroupTest {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	public GroupMyMygroupTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupMyMygroupTest.xls";
		this.tcEntry.TestSuitName=testsuitname;
		//this.tcEntry.tcLogFilePathName=logfile.getAbsolutePath();
		this.tcEntry.logFile=logfile;
		this.tcm=tcmanager;
	}
	public void MyMygroup() throws IOException{
		this.tcEntry.tcName="MyMygroup";
