...
public class GroupTopicFavdelTest {
	public TestcaseEntry tcEntry;
	public TestcaseManager tcm;
	public GroupTopicFavdelTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupTopicFavdelTest.xls";
		this.tcEntry.TestSuitName=testsuitname;
		//this.tcEntry.tcLogFilePathName=logfile.getAbsolutePath();
		this.tcEntry.logFile=logfile;
		this.tcm=tcmanager;
	}
	public void TopicFavdel() throws IOException{
		this.tcEntry.tcName="TopicFavdel";
	...
	public void TopicFavdel_WrongId() throws Exception{
		this.tcEntry.tcName="TopicFavdel_WrongId";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		Testcase.getResponse(this.tcEntry);
		result=Testcase.VerfyResult(this.tcEntry);
	...
	public void TopicFavdel_NullId() throws Exception{
		this.tcEntry.tcName="TopicFavdel_NullId";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		Testcase.getResponse(this.tcEntry);
		result=Testcase.VerfyResult(this.tcEntry);
