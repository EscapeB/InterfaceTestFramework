...
public class GroupAdminDelreplyTest {
	public TestcaseEntry tcEntry;
	public TestcaseManager tcm;
	private String replylikeId;
	public GroupAdminDelreplyTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupAdminDelreplyTest.xls";
		this.tcEntry.TestSuitName=testsuitname;
		//this.tcEntry.tcLogFilePathName=logfile.getAbsolutePath();
		this.tcEntry.logFile=logfile;
		this.tcm=tcmanager;
	}
	public void AdminDelreply() throws IOException{
		BeforeReplyDel();
		this.tcEntry.tcName="AdminDelreply";
...
//	   System.out.println(t.jsonResponse.toString());
	...
	public void AdminDelreply_NullReplyid() throws Exception{
		this.tcEntry.tcName="AdminDelreply_NullReplyid";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		Testcase.getResponse(this.tcEntry);
		result=Testcase.VerfyResult(this.tcEntry);
	...
	public void AdminDelreply_WrongReplyid() throws Exception{
		this.tcEntry.tcName="AdminDelreply_WrongReplyid";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		Testcase.getResponse(this.tcEntry);
		result=Testcase.VerfyResult(this.tcEntry);
	...
	public void AdminDelreply_AlreadyDel() throws Exception{
		this.tcEntry.tcName="AdminDelreply_AlreadyDel";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		Testcase.getResponse(this.tcEntry);
		result=Testcase.VerfyResult(this.tcEntry);
