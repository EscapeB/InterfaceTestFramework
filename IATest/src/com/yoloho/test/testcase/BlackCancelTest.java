...
//取消黑名单
public class BlackCancelTest {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public BlackCancelTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_BlackCancelTest.xls";
	...
	public void AfterTest()
	{
		...
		tc.APIURL = "https://uicapi.test.yoloho.com/black/add";
