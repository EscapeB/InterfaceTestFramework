...
public class GroupTopicRecommend_v2Test {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public GroupTopicRecommend_v2Test(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupTopicRecommend_v2Test.xls";
		this.tcEntry.TestSuitName=testsuitname;
		//this.tcEntry.tcLogFilePathName=logfile.getAbsolutePath();
		this.tcEntry.logFile=logfile;
		this.tcm=tcmanager;
	}
	public void TopicRecommend_v2() throws IOException{
		this.tcEntry.tcName="TopicRecommend_v2";
