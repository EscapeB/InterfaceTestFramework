...
public class FollowCancelTest {
	...
	public FollowCancelTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_FollowCancelTest.xls";
	...
	public void AfterTest()
	{
		...
		tc.APIURL = "https://uicapi.test.yoloho.com/follow/add";
