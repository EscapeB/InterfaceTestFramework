...
public class GroupTransferRefuseTest {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	private String cancleId;
	public GroupTransferRefuseTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupTransferRefuseTest.xls";
...
//		String transferId=json.get("id").toString();
	...
	public void GroupTransferRefuse_WrongId() throws Exception{
		this.tcEntry.tcName="GroupTransferRefuse_WrongId";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		Testcase.getResponse(this.tcEntry);
		result=Testcase.VerfyResult(this.tcEntry);
