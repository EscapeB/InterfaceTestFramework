...
public class TagTopicRecommendTest {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public TagTopicRecommendTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_TagTopicRecommendTest.xls";
