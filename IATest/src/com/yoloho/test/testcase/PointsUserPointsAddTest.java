...
public class PointsUserPointsAddTest 
{
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public PointsUserPointsAddTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_PointsUserPointsAddTest.xls";
