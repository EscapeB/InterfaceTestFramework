...
public class PointsUserPointsCountTest 
{
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public PointsUserPointsCountTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_PointsUserPointsCountTest.xls";
