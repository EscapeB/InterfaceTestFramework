...
public class GroupAdminHaspermitTest {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	public GroupAdminHaspermitTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupAdminHaspermitTest.xls";
		this.tcEntry.TestSuitName=testsuitname;
		//this.tcEntry.tcLogFilePathName=logfile.getAbsolutePath();
		this.tcEntry.logFile=logfile;
		this.tcm=tcmanager;
	}
	public void GroupAdminHaspermitlist() throws Exception{
		this.tcEntry.tcName="GroupAdminHaspermitlist";
	...
	public void GroupAdminHaspermitlist_NoGroupid() throws Exception{
		this.tcEntry.tcName="GroupAdminHaspermitlist_NoGroupid";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		Testcase.getResponse(this.tcEntry);
		result=Testcase.VerfyResult(this.tcEntry);
	...
	public void GroupAdminHaspermitlist_WrongGroupid() throws Exception{
		this.tcEntry.tcName="GroupAdminHaspermitlist_WrongGroupid";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		Testcase.getResponse(this.tcEntry);
		result=Testcase.VerfyResult(this.tcEntry);
