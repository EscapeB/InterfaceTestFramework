...
public class GroupTransferSearchTest {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public GroupTransferSearchTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupTransferSearchTest.xls";
		this.tcEntry.TestSuitName=testsuitname;
		//this.tcEntry.tcLogFilePathName=logfile.getAbsolutePath();
		this.tcEntry.logFile=logfile;
		this.tcm=tcmanager;
	}
	public void TransferSearch() throws IOException{
		this.tcEntry.tcName="TransferSearch";
	...
	public void TransferSearchEmpty() throws Exception{
		this.tcEntry.tcName="TransferSearchEmpty";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		Testcase.getResponse(this.tcEntry);
		result=Testcase.VerfyResult(this.tcEntry);
