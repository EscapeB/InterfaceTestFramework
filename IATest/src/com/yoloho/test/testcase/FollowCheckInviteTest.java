...
public class FollowCheckInviteTest 
{
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public FollowCheckInviteTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_FollowCheckInviteTest.xls";
