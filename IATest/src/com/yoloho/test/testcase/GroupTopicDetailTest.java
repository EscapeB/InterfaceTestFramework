...
public class GroupTopicDetailTest {
	public TestcaseEntry tcEntry;
	public TestcaseManager tcm;
	
	public GroupTopicDetailTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupTopicDetailTest.xls";
		this.tcEntry.TestSuitName=testsuitname;
		//this.tcEntry.tcLogFilePathName=logfile.getAbsolutePath();
		this.tcEntry.logFile=logfile;
		this.tcm=tcmanager;
	}
	public void TopicGetDetail() throws IOException{
		this.tcEntry.tcName="TopicGetDetail";
