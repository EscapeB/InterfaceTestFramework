...
public class GroupGroupMemberlistTest {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public GroupGroupMemberlistTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupGroupMemberlistTest.xls";
	...
	public void GroupMemberlist() throws IOException{
		this.tcEntry.tcName="GroupMemberlist";
