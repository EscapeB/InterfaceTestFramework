...
public class PointsLevelRuleListTest {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public PointsLevelRuleListTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_PointsLevelRuleListTest.xls";
