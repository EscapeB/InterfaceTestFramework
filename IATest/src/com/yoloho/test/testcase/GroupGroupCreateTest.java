...
public class GroupGroupCreateTest {
	public TestcaseEntry tcEntry;
	public TestcaseManager tcm;
	
	public GroupGroupCreateTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupGroupCreateTest.xls";
	...
	public void GroupCreate() throws IOException{
		this.tcEntry.tcName="GroupCreate";
