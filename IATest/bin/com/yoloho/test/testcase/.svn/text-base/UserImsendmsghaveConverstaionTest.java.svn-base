...
public class UserImsendmsghaveConverstaionTest 
{
	private TestcaseEntry tcEntry;
	//private TestcaseEntry afterTC;
	private TestcaseManager tcm;
	
	public UserImsendmsghaveConverstaionTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_UserImsendmsghaveConverstaionTest.xls";
