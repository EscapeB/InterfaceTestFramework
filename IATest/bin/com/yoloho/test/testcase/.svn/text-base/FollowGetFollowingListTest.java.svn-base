...
public class FollowGetFollowingListTest {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public FollowGetFollowingListTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_FollowGetFollowingListTest.xls";
