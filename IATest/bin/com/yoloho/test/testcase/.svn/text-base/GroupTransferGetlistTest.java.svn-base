...
public class GroupTransferGetlistTest {
	public TestcaseEntry tcEntry;
	public TestcaseManager tcm;
	
	public GroupTransferGetlistTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupTransferGetlistTest.xls";
		this.tcEntry.TestSuitName=testsuitname;
		//this.tcEntry.tcLogFilePathName=logfile.getAbsolutePath();
		this.tcEntry.logFile=logfile;
		this.tcm=tcmanager;
	}
	public void TransferGetlist() throws IOException{
		this.tcEntry.tcName="TransferGetlist";
