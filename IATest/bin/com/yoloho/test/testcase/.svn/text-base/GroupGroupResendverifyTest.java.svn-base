...
public class GroupGroupResendverifyTest {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public GroupGroupResendverifyTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupGroupResendverifyTest.xls";
		this.tcEntry.TestSuitName=testsuitname;
		//this.tcEntry.tcLogFilePathName=logfile.getAbsolutePath();
		this.tcEntry.logFile=logfile;
		this.tcm=tcmanager;
	}
	public void GroupResendverfiy() throws IOException{
		this.tcEntry.tcName="GroupResendverfiy";
	...
	public void GroupResendverfiyWrongGroup_id() throws Exception{
		this.tcEntry.tcName="GroupResendverfiyWrongGroup_id";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		Testcase.getResponse(this.tcEntry);
		result=Testcase.VerfyResult(this.tcEntry);
	...
	public void GroupResendverfiyNotOwner() throws Exception{
		this.tcEntry.tcName="GroupResendverfiyNotOwner";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		Testcase.getResponse(this.tcEntry);
		result=Testcase.VerfyResult(this.tcEntry);
	...
	public void GroupResendverfiyWrongMibile() throws Exception{
		this.tcEntry.tcName="GroupResendverfiyWrongMibile";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		Testcase.getResponse(this.tcEntry);
		result=Testcase.VerfyResult(this.tcEntry);
