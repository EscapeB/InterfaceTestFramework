...
public class GroupAdminHasauditTest {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	public GroupAdminHasauditTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupAdminHasauditTest.xls";
		this.tcEntry.TestSuitName=testsuitname;
		//this.tcEntry.tcLogFilePathName=logfile.getAbsolutePath();
		this.tcEntry.logFile=logfile;
		this.tcm=tcmanager;
	}
	public void GroupAdminHasaudit() throws Exception{
		this.tcEntry.tcName="GroupAdminHasaudit";
	...
	public void GroupAdminHasaudit_NoGroupid() throws Exception{
		this.tcEntry.tcName="GroupAdminHasaudit_NoGroupid";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		Testcase.getResponse(this.tcEntry);
		result=Testcase.VerfyResult(this.tcEntry);
	...
	public void GroupAdminHasaudit_WrongGroupid() throws Exception{
		this.tcEntry.tcName="GroupAdminHasaudit_WrongGroupid";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		Testcase.getResponse(this.tcEntry);
		result=Testcase.VerfyResult(this.tcEntry);
