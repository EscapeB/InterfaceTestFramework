...
public class UserLoginTest1 
{
	...
	public UserLoginTest1(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_UserLoginTest1.xls";
	...
	public void Testcase_08() throws IOException
	{
		...
		this.tcEntry.tcName="Testcase_08";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		//this.preCondition();
		Testcase.getResponse(this.tcEntry);
	...
	public void Testcase_09() throws IOException
	{
		...
		this.tcEntry.tcName="Testcase_09";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		//this.preCondition();
		Testcase.getResponse(this.tcEntry);
	...
	public void Testcase_10() throws IOException
	{
		...
		this.tcEntry.tcName="Testcase_10";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		//this.preCondition();
		Testcase.getResponse(this.tcEntry);
	...
	public void Testcase_11() throws IOException
	{
		...
		this.tcEntry.tcName="Testcase_11";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		//this.preCondition();
		Testcase.getResponse(this.tcEntry);
	...
	public void Testcase_12() throws IOException
	{
		
		this.tcEntry.tcName="Testcase_12";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		//this.preCondition();
		Testcase.getResponse(this.tcEntry);
	...
	public void Testcase_13() throws IOException
	{
		...
		this.tcEntry.tcName="Testcase_13";
		boolean result=false;
		Testcase.getTestdata(this.tcEntry);
		//this.preCondition();
		Testcase.getResponse(this.tcEntry);
