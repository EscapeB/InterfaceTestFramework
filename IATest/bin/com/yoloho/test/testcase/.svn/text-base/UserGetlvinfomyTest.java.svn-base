...
public class UserGetlvinfomyTest 
{
	private TestcaseEntry tcEntry;
	//private TestcaseEntry afterTC;
	private TestcaseManager tcm;
	
	public UserGetlvinfomyTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_UserGetlvinfomyTest.xls";
	...
	public void Testcase_01() throws IOException
	{
		...
		tcEntry.jsonExpectedResult.remove("visited");
		tcEntry.jsonExpectedResult.put("visited", tcEntry.jsonResponse.get("visited"));
