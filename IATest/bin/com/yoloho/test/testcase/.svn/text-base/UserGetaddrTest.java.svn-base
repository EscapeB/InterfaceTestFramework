...
public class UserGetaddrTest 
{
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public UserGetaddrTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_UserGetaddrTest.xls";
