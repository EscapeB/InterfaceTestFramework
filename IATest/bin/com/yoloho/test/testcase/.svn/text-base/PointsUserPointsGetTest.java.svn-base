...
public class PointsUserPointsGetTest 
{
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public PointsUserPointsGetTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_PointsUserPointsGetTest.xls";
