...
public class FollowGetFollowingTopicsTest {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public FollowGetFollowingTopicsTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_FollowGetFollowingTopicsTest.xls";
