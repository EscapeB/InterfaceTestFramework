...
public class GroupMyMyjoinTest {
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public GroupMyMyjoinTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupMyMyjoinTest.xls";
		this.tcEntry.TestSuitName=testsuitname;
		//this.tcEntry.tcLogFilePathName=logfile.getAbsolutePath();
		this.tcEntry.logFile=logfile;
		this.tcm=tcmanager;
	}
	public void MyMyjoin() throws IOException{
		this.tcEntry.tcName="MyMyjoin";
