...
public class PointsUserPointsLevelupTest 
{
	private TestcaseEntry tcEntry;
	private TestcaseManager tcm;
	
	public PointsUserPointsLevelupTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath)
	{
		this.tcEntry = new TestcaseEntry();
		this.tcEntry.tcFilePathName=testdatapath+"TC_PointsUserPointsLevelupTest.xls";
