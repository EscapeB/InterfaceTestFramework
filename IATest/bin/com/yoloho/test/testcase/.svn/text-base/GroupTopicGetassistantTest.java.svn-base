...
public class GroupTopicGetassistantTest {
	public TestcaseEntry tcEntry;
	public TestcaseManager tcm;
	public GroupTopicGetassistantTest(TestcaseManager tcmanager,String testsuitname,File logfile,String testdatapath){
		this.tcEntry = new TestcaseEntry();
		//this.tcEntry.tcFilePathName="./testdata/TC_UserLoginTest.xls";
		this.tcEntry.tcFilePathName=testdatapath+"TC_GroupTopicGetassistantTest.xls";
		this.tcEntry.TestSuitName=testsuitname;
		//this.tcEntry.tcLogFilePathName=logfile.getAbsolutePath();
		this.tcEntry.logFile=logfile;
		this.tcm=tcmanager;
	}
	public void TopicGetassistant() throws IOException{
		this.tcEntry.tcName="TopicGetassistant";
...
//	public void TopicGetDetail_WrongId() throws Exception{
//		this.tcEntry.tcName="TopicGetDetail_WrongId";
//		boolean result=false;
//		Testcase.getTestdata(this.tcEntry);
//		Testcase.getResponse(this.tcEntry);
//		result=Testcase.VerfyResult(this.tcEntry);
...
//		this.tcm.updateTestResult(this.tcEntry);
//	}
//	public void TopicGetDetail_NullId() throws Exception{
//		this.tcEntry.tcName="TopicGetDetail_NullId";
//		boolean result=false;
//		Testcase.getTestdata(this.tcEntry);
//		Testcase.getResponse(this.tcEntry);
//		result=Testcase.VerfyResult(this.tcEntry);
